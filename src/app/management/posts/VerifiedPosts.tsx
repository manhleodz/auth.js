...
export default function VerifiedPosts({ verifiedPosts, user }: { verifiedPosts: any, user: any }) {
    const [modal, setModal] = useState(null);

    return (
        <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
            <h1 className=" text-xl font-bold">Bài viết đã xác thực</h1>
            <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    {verifiedPosts.length > 0 && verifiedPosts.map((p: any) => (
